...
import { Building2, ArrowRight, Bell, Sparkles } from 'lucide-react'
    ...
    <div className="min-h-screen pt-24 flex items-center justify-center px-4">
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          ...
          <Building2 className="w-16 h-16 text-saffron-500/40 mx-auto mb-6" />
          ...
          <p className="text-gray-400 text-lg leading-relaxed mb-8">
            AI-powered real estate services — property listings, virtual tours, AI voice agents for site visit bookings, investment analysis, and lead generation for developers and brokers.
          </p>
