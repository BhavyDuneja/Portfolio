...
import { Plane, ArrowRight, Bell, Sparkles } from 'lucide-react'
    ...
    <div className="min-h-screen pt-24 flex items-center justify-center px-4">
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          ...
          <Plane className="w-16 h-16 text-saffron-500/40 mx-auto mb-6" />
          ...
          <p className="text-gray-400 text-lg leading-relaxed mb-8">
            End-to-end immigration assistance — visa guidance, documentation support, country-specific pathways, and AI-powered eligibility assessment for students, professionals, and families.
          </p>
