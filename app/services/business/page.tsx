...
import { LayoutGrid, ArrowRight, Bell, Sparkles } from 'lucide-react'
    ...
    <div className="min-h-screen pt-24 flex items-center justify-center px-4">
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          ...
          <LayoutGrid className="w-16 h-16 text-saffron-500/40 mx-auto mb-6" />
          ...
          <p className="text-gray-400 text-lg leading-relaxed mb-8">
            End-to-end business consulting — company registration, compliance, financial planning, operations optimization, and growth strategy for startups and SMEs across India.
          </p>
