...
import { ShoppingCart, ArrowRight, Bell, Sparkles } from 'lucide-react'
    ...
    <div className="min-h-screen pt-24 flex items-center justify-center px-4">
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          ...
          <ShoppingCart className="w-16 h-16 text-saffron-500/40 mx-auto mb-6" />
          ...
          <p className="text-gray-400 text-lg leading-relaxed mb-8">
            Full-stack e-commerce enablement — from store setup and product cataloging to AI-powered sales, logistics integration, and growth marketing. Built for Indian D2C brands ready to scale.
          </p>
