...
async function getPost(id: string) {
  try {
    ...
    let { data } = await supabase
      .from('blog_posts')
      .select('title, category, author_name, read_time')
      .eq('slug', id)
      .single()
    ...
    (
      ...
      >
        ...
        <div style={{
          ...
          background: `${colors.accent}25`, filter: 'blur(100px)',
        }} />
        <div style={{
          position: 'absolute', bottom: '-100px', left: '-80px',
          width: '400px', height: '400px', borderRadius: '50%',
          background: '#E8A31718', filter: 'blur(80px)',
        }} />
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', zIndex: 1 }}>
          <div style={{
            background: 'linear-gradient(135deg, #E8A317, #F0C040)',
            borderRadius: '10px',
            padding: '8px 20px',
            fontSize: '22px',
            fontWeight: '800',
        ...
        <div style={{
          ...
          background: `linear-gradient(90deg, ${colors.accent}, #E8A317)`,
          borderRadius: '2px',
          marginBottom: '28px',
          zIndex: 1,
        }} />
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <div style={{
              ...
              background: `linear-gradient(135deg, ${colors.accent}, #E8A317)`,
