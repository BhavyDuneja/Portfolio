...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" ref={ref} className="section-spacing bg-gradient-to-b from-green-50/30 to-white">
      <div className="container mx-auto px-4">
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex justify-center mb-6">
                <div className="w-16 h-16 bg-gradient-to-r from-green-100 to-green-200 rounded-full flex items-center justify-center">
        ...
        >
          <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-3xl p-12 border border-green-100">
            <h3 className="text-3xl font-bold mb-6 text-gray-800">Professional Philosophy</h3>
