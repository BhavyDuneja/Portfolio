...
const Projects = () => {
  ...
  return (
    <section id="projects" ref={ref} className="section-spacing bg-gradient-to-b from-white to-green-50/30">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {filteredProjects.map((project, index) => (
            <motion.div
              ...
              className={`${project.bgColor} rounded-3xl p-8 border ${project.borderColor} hover-lift cursor-pointer`}
              ...
              <div className="flex items-start justify-between mb-6">
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-3">
                    <Code className={`w-6 h-6 text-gradient-to-r ${project.color}`} />
                    <h3 className="text-2xl font-bold text-gray-800">{project.title}</h3>
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                      project.status === 'Current' ? 'bg-green-100 text-green-700' :
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.technologies.map((tech) => (
                    <span
                      key={tech}
                      className="px-3 py-1 bg-white rounded-full text-sm font-medium border border-gray-200 hover:scale-105 transition-transform duration-200"
                    >
                      {tech}
                    </span>
                  ))}
        ...
        >
          {[
            ...
            <motion.div
              ...
              className="text-center bg-white rounded-2xl p-6 shadow-lg border border-green-100 hover-lift"
            >
